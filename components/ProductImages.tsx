    ...
    return <>
        ...
        <div className={``}>
            ...
            <div className={`flex m-3 items-center justify-center`}>
                ...
                <svg onClick={() => setImgIndexTransform((prev) => imgIndexTransform >= images.length - 4 ? prev : prev + 1)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-12 h-12 cursor-pointer select-none ${images.length < 3 && "pointer-events-none opacity-50"}`}>
